...
namespace Services.Interfaces
{
    public interface IClassScheduleService
    {
        ...
        Task<IEnumerable<ClassScheduleResponse>> GetAllClassSchedule(Guid? subjectId, DayOfWeek? dayOfWeek, TimeOnly? startTime, TimeOnly? endTime, DateOnly? startDate, DateOnly? endDate, int pageNumber, int pageSize);
